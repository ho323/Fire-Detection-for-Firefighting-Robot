...
SAFETY_CLASSES = ["안전밸트 착용", "안전밸트 미착용", "안전고리 결착", "안전고리 미결착", "안전화 착용", "안전화 미착용", "안전모 착용", "안전모 미착용", 
              "포크레인", "페이로다", "지게차", "덤프트럭", "레미콘", "펌프카", "항타기", "트럭", "고소작업대", "타워크레인", "스카이", "갱폼",
              "알폼", "A형 사다리", "우마", "분전반", "개구부 덮개", "위험물보관소", "ELEV.추락방지막", "호이스트", "잭서포트", "강관비계", "시스템 비계",
              "시멘트벽돌", "망치", "전동드릴", "레미탈", "치장블럭", "믹서기", "H빔", "고속절단기", "바이브레이터", "소화기", "용접기", "핸드그라인더",
              "핸드카", "불티방지막"
              ]
"""
...
safety_dataset = dataset_base.copy({
    ...
    'train_info': 'G:/Safety_DB_A/training/annotations.json',
    'valid_images': 'G:/Safety_DB_A/validata/',
    'valid_info':   'G:/Safety_DB_A/validate/annotations.json',
...
smoke_dataset = dataset_base.copy({
    'name': 'SMOKE 2020',
    'train_images': './data/Fire/training/',
    'train_info': './data/Fire/training/annotations.json',
    'valid_images': './data/Fire/validata/',
    'valid_info':   './data/Fire/validata/annotations.json',
